...
**YOU ARE IN: `gastown_demo/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gastown_demo/` (rig root) or other directories
...
**Your mail address:** `gastown_demo/polecats/rust`
**Your rig:** gastown_demo
**Your Witness:** `gastown_demo/witness`
...
| Ask Witness for help | `gt mail send gastown_demo/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gastown_demo/witness`) when:
...
```bash
gt mail send gastown_demo/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
